...
type SysInstitution struct {
	...
	InstitutionType     uint             `json:"institutionType"  gorm:"comment:机构类型"`                                  // 机构名称
	InstitutionProp     uint             `json:"InstitutionProp"  gorm:"comment:机构属性"`                                  // 机构类型
	InstitutionLevel    uint             `json:"institutionLevel" gorm:"comment:机构层级"`
	InstitutionInterval uint             `json:"institutionInterval" gorm:"comment:机构区间"`
