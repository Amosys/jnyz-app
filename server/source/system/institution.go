...
func (i *initInstitution) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []sysModel.SysInstitution{
		...
		{InstitutionId: 3414696007, InstitutionName: "市场部", InstitutionType: 1, InstitutionProp: 3, InstitutionLevel: 5, ParentId: utils.Pointer[uint](3414696094)},
		...
		{InstitutionId: 3414696095, InstitutionName: "营业部", InstitutionType: 1, InstitutionProp: 3, InstitutionLevel: 5, ParentId: utils.Pointer[uint](3414696094)},
