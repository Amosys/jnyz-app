...
func (i *initApi) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []sysModel.SysApi{
		...
		{ApiGroup: "系统用户", Method: "PUT", Path: "/user/setUserInstitution", Description: "设置角色所属机构"},
		...
		{ApiGroup: "机构", Method: "POST", Path: "/institution/createInstitution", Description: "创建机构"},
		...
		{ApiGroup: "数据", Method: "POST", Path: "/data/depositSub", Description: "创建各项存款详情记录"},
		{ApiGroup: "数据", Method: "GET", Path: "/data/depositSub", Description: "获取各项存款详情记录"},
		{ApiGroup: "数据", Method: "GET", Path: "/data/depositSubList", Description: "获取各项存款详情记录列表"},
		{ApiGroup: "数据", Method: "POST", Path: "/data/depositDetailCorp", Description: "创建对公存款详情记录"},
		{ApiGroup: "数据", Method: "GET", Path: "/data/depositDetailCorp", Description: "获取对公存款详情记录"},
		{ApiGroup: "数据", Method: "GET", Path: "/data/depositDetailCorpList", Description: "获取对公存款详情记录列表"},
		{ApiGroup: "数据", Method: "POST", Path: "/data/depositDetailCur", Description: "创建活期存款详情记录"},
		{ApiGroup: "数据", Method: "GET", Path: "/data/depositDetailCur", Description: "获取活期存款详情记录"},
		{ApiGroup: "数据", Method: "GET", Path: "/data/depositDetailCurList", Description: "获取活期存款详情记录列表"},
		{ApiGroup: "数据", Method: "POST", Path: "/data/depositDetailSave", Description: "创建储蓄存款详情记录"},
		{ApiGroup: "数据", Method: "GET", Path: "/data/depositDetailSave", Description: "获取储蓄存款详情记录"},
		{ApiGroup: "数据", Method: "GET", Path: "/data/depositDetailSaveList", Description: "获取储蓄存款详情记录列表"},
		{ApiGroup: "数据", Method: "POST", Path: "/data/depositBank", Description: "创建法人行存款详情记录"},
		{ApiGroup: "数据", Method: "GET", Path: "/data/depositBank", Description: "获取法人行存款详情记录"},
		{ApiGroup: "数据", Method: "GET", Path: "/data/depositBankList", Description: "获取法人行存款详情记录列表"},
		{ApiGroup: "数据", Method: "POST", Path: "/data/depositTrands", Description: "创建法人行存款趋势记录"},
		{ApiGroup: "数据", Method: "GET", Path: "/data/depositTrands", Description: "获取法人行存款趋势记录"},
		{ApiGroup: "数据", Method: "GET", Path: "/data/depositTrandsList", Description: "获取法人行存款趋势记录列表"},
		{ApiGroup: "数据", Method: "POST", Path: "/data/depositTop50", Description: "创建存款大户记录"},
		{ApiGroup: "数据", Method: "GET", Path: "/data/depositTop50List", Description: "获取存款大户列表"},

		{ApiGroup: "数据", Method: "POST", Path: "/data/loanSub", Description: "创建各项贷款款详情记录"},
		{ApiGroup: "数据", Method: "GET", Path: "/data/loanSub", Description: "获取各项贷款详情记录"},
		{ApiGroup: "数据", Method: "GET", Path: "/data/loanSubList", Description: "获取各项贷款详情记录列表"},
		{ApiGroup: "数据", Method: "POST", Path: "/data/loanDetailCorp", Description: "创建对公贷款详情记录"},
		{ApiGroup: "数据", Method: "GET", Path: "/data/loanDetailCorp", Description: "获取对公贷款详情记录"},
		{ApiGroup: "数据", Method: "GET", Path: "/data/loanDetailCorpList", Description: "获取对公贷款详情记录列表"},
		{ApiGroup: "数据", Method: "POST", Path: "/data/loanDetailPers", Description: "创建储蓄贷款详情记录"},
		{ApiGroup: "数据", Method: "GET", Path: "/data/loanDetailPers", Description: "获取储蓄贷款详情记录"},
		{ApiGroup: "数据", Method: "GET", Path: "/data/loanDetailPersList", Description: "获取储蓄贷款详情记录列表"},
		{ApiGroup: "数据", Method: "POST", Path: "/data/loanBank", Description: "创建法人行贷款详情记录"},
		{ApiGroup: "数据", Method: "GET", Path: "/data/loanBank", Description: "获取法人行贷款详情记录"},
		{ApiGroup: "数据", Method: "GET", Path: "/data/loanBankList", Description: "获取法人行贷款详情记录列表"},
		{ApiGroup: "数据", Method: "POST", Path: "/data/loanTrands", Description: "创建法人行贷款趋势记录"},
		{ApiGroup: "数据", Method: "GET", Path: "/data/loanTrands", Description: "获取法人行贷款趋势记录"},
		{ApiGroup: "数据", Method: "GET", Path: "/data/loanTrandsList", Description: "获取法人行贷款趋势记录列表"},
	}
