...
func (i *initDict) InitializeData(ctx context.Context) (next context.Context, err error) {
	...
	entities := []sysModel.SysDictionary{
		...
		{Name: "机构类型", Type: "institutionType", Status: &True, Desc: "机构类型字典"},
		{Name: "机构属性", Type: "institutionProp", Status: &True, Desc: "机构属性字典"},
		{Name: "机构层级", Type: "institutionLevel", Status: &True, Desc: "机构层级字典"},
	}
