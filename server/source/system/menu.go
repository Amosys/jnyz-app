...
func (i *initMenu) InitializeData(ctx context.Context) (next context.Context, err error) {
	...
	entities := []SysBaseMenu{
		...
		{MenuLevel: 0, Hidden: false, ParentId: "2", Path: "institution", Name: "institution", Component: "view/superAdmin/institution/institution.vue", Sort: 5, Meta: Meta{Title: "机构管理", Icon: "coordinate", KeepAlive: true}},
		{MenuLevel: 0, Hidden: false, ParentId: "2", Path: "dictionary", Name: "dictionary", Component: "view/superAdmin/dictionary/sysDictionary.vue", Sort: 6, Meta: Meta{Title: "字典管理", Icon: "notebook"}},
		...
		{MenuLevel: 0, Hidden: false, ParentId: "11", Path: "exportTemplate", Name: "exportTemplate", Component: "view/systemTools/exportTemplate/exportTemplate.vue", Sort: 10, Meta: Meta{Title: "表格模板", Icon: "reading"}},
		...
		{MenuLevel: 0, Hidden: false, ParentId: "19", Path: "appCloudSpeaker", Name: "appCloudSpeaker", Component: "view/appCloudSpeaker/appCloudSpeaker.vue", Sort: 1, Meta: Meta{Title: "云音响管理", Icon: "reading"}},
	}
